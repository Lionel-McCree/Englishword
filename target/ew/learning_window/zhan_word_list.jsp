    ...
    <div class="word_main">
      <div class="word_main_thead">
        ...
        <div class="word_main_list_s">
         <span class="word_main_list_tip">点击恢复可以将已斩的单词恢复到学习计划中</span>
         释义
        </div>
      </div>
...
<script>
  var zhan_num = '<%=(Integer)session.getAttribute("zhan_num")%>';
  var page_action=1;
