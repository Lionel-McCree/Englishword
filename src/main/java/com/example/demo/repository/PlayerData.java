...
public class PlayerData{
    //记录用户状态的并发HashMap
    private  ConcurrentHashMap<Integer, StatusEnum> userToStatus = new ConcurrentHashMap<Integer, StatusEnum>();
    //记录是否匹配超时
    public  ConcurrentHashMap<Integer, Boolean> isConnect = new ConcurrentHashMap<Integer, Boolean>();
    //暂时存储用户的问题
    public  ConcurrentHashMap<Integer,String> userQuest = new ConcurrentHashMap<Integer,String>();
    //public  ConcurrentHashMap<Integer,Integer> questSignal = new ConcurrentHashMap<>();
    //记录两个用户的匹配的并发HashMap
    //两边相互记录
    private  ConcurrentHashMap<Integer, Integer> userToPlay = new ConcurrentHashMap<Integer, Integer>();

    public ConcurrentHashMap<Integer,Integer> userOvertime = new ConcurrentHashMap<Integer,Integer>();
    private  ConcurrentHashMap<Integer, Integer> userToLeave = new ConcurrentHashMap<Integer,Integer>();
    private ConcurrentHashMap<Integer,String> UserToSessionID = new ConcurrentHashMap<Integer,String>();
    private ConcurrentHashMap<Integer, ReportForm> reportCard = new ConcurrentHashMap<Integer, ReportForm>();
